...
docker build -f DockerfileA_1 -t menedev/testimagea:2.0.0 -t menedev/testimagea:2.0 -t menedev/testimagea:2 -t menedev/testimagea:edge -t menedev/testimagea:latest .
